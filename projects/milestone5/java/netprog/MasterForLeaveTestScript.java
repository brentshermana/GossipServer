...
import netprog.client.clientapp.ClientAppForLeaveTestScript;
 ...
 */
public class MasterForLeaveTestScript {
	...
	public static void main (String[] args) {
        ...
        //start client
        ClientAppForLeaveTestScript client = new ClientAppForLeaveTestScript(udp, port, message, timeStamp, "127.0.0.1", clientLock);
